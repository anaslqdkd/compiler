...
$I$ & $\to$ & \textbf{ident} $I'$\\
$I'$ & $\to$ & , \textbf{ident} $I' \ | \ \varepsilon$\\
$B$ & $\to$ & $C$ \textbf{Newline} | \textbf{Newline} \textbf{Begin} $DB'$ \textbf{End}\\
$B'$ & $\to$ & \textbf{Newline} $DB' \ | \ \varepsilon$\\
$C$ & $\to$ & \textbf{return} $E$ | \textbf{ident} $C''$ | $EC'$ | \textbf{print}$(E)$\\
$C'$ & $\to$ & $[E]=E \ | \ \varepsilon$\\
$C''$ & $\to$ & $= E \ | \ (E''') \ | \ \varepsilon$\\
$D$ & $\to$ & $C$ \textbf{Newline} | \textbf{if} $E$ : $BD'$ | \textbf{for} \textbf{indent} \textbf{in} $E$ : $B$\\
$D'$ & $\to$ & \textbf{else :} $B$ | $\varepsilon$\\
$E$ & $\to$ & $G \ | \ H \ | \ $ \textbf{True} | \textbf{False} | \textbf{None} | $EE' \ | \ -E$ | \textbf{not} $E \ | \ [E''] \ | \ (E)$\\
$E'$ & $\to$ & $FE \ | \ [E]$\\
$E''$ & $\to$ & $EE''' \ | \ \varepsilon$\\
$E'''$ & $\to$ & $,EE''' \ | \ \varepsilon$\\
$F$ & $\to$ & + | - | * | // | \% | <= | >= | < | > | != | == | \textbf{and} | \textbf{or} \\
$G$ & $\to$ & $0G' \ | \ 1G' \ | \ 2G' \ | \ 3G' \ | \ 4G' \ | \ 5G' \ | \ 6G' \ | \ 7G' \ | \ 8G' \ | \ 9G'$\\
$G'$ & $\to$ & $0G' \ | \ 1G' \ | \ 2G' \ | \ 3G' \ | \ 4G' \ | \ 5G' \ | \ 6G' \ | \ 7G' \ | \ 8G' \ | \ 9G \ | \ \varepsilon$\\
$H$ & $\to$ & "$H'$"\\
$H'$ & $\to$ & $\beta H'$ où $\beta \in \alpha \cup \mathcal{D} \cup \lbrace +;-;*;/;\%;(;[;);];\backslash \rbrace \cup \lbrace \backslash "\rbrace$
\end{tabular}
}
\caption{\textcolor{blue}{Grammaire LL(2)}}
\label{grammar_ll2}
\end{center}\end{figure}
